#include "../../lib/IOThreadPoolServer/CSession.h"
#include "../../lib/IOThreadPoolServer/CServer.h"
#include "../../lib/IOThreadPoolServer/LogicServer.h"
...
void CSession::Send( std::string msg, short msgid ) {
    ...
    boost::asio::async_write( _socket,
        ...
        boost::asio::bind_executor(
            _strand, std::bind( &CSession::HandleWrite, this,
...
void CSession::HandleRead( const boost::system::error_code &error,
    ...
    try {
        if ( !error ) {
            ...
            _socket.async_read_some( boost::asio::buffer( _data, MAX_LENGTH ),
                boost::asio::bind_executor(
                    _strand, std::bind( &CSession::HandleRead, this,
