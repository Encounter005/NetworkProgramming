#include "../../lib/AsyncServerV3/CSession.h"
#include "../../lib/AsyncServerV3/CServer.h"
#include "../../lib/AsyncServerV3/LogicServer.h"
        ...
        if ( !error ) {
            ...
            while ( bytes_transferred > 0 ) {
                if ( !_b_head_parse ) {
                    ...
                    // 头部剩余未复制的长度
                    int head_remain =
                        HEAD_TOTAL_LEN - _recv_head_node->_cur_len;
                    ...
                    // cout << "receive data is " << _recv_msg_node->_data <<
                    // endl; 此处将消息投递到逻辑队列中
                    LogicSystem::GetInstance()->PostMsgToQue(
                        make_shared<LogicNode>(
